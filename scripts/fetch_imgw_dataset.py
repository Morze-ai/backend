...
def fetch_imgw_data(station_id: int) -> None:
    """
    ...
    url = f"https://danepubliczne.imgw.pl/api/data/synop/station/{station_id}"
    ...
    if response.status_code == 200:
        ...
        df.to_csv(f"data/raw/{station_id}_latest.csv", index=False)
